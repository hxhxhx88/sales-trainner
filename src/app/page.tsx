...
export default function Home() {
  ...
  return (
    <>
      {/* Persistent audio element — never unmounted across phase transitions */}
      <audio ref={store.audioRef} autoPlay playsInline className="hidden" />
      ...
      {/* Active session */}
      {store.phase === 'active' && store.selectedPersona && (
        <MeetingRoom
      ...
      {/* Review */}
      {store.phase === 'review' && store.outcome && (
        <ReviewPage
